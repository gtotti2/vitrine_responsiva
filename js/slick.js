! function(i) {
    ...
    (e = function() {
        ...
        var t, o, s, n = this,
            r = 0;
        if (n.slideOffset = 0, o = n.$slides.first().outerHeight(!0), !0 === n.options.infinite ? (n.slideCount > n.options.slidesToShow && (n.slideOffset = n.slideWidth * n.options.slidesToShow * -1, r = o * n.options.slidesToShow * -1), n.slideCount % n.options.slidesToScroll != 0 && e + n.options.slidesToScroll > n.slideCount && n.slideCount > n.options.slidesToShow && (e > n.slideCount ? (n.slideOffset = (n.options.slidesToShow - (e - n.slideCount)) * n.slideWidth * -1, r = (n.options.slidesToShow - (e - n.slideCount)) * o * -1) : (n.slideOffset = n.slideCount % n.options.slidesToScroll * n.slideWidth * -1, r = n.slideCount % n.options.slidesToScroll * o * -1))) : e + n.options.slidesToShow > n.slideCount && (n.slideOffset = (e + n.options.slidesToShow - n.slideCount) * n.slideWidth, r = (e + n.options.slidesToShow - n.slideCount) * o), n.slideCount <= n.options.slidesToShow && (n.slideOffset = 0, r = 0), !0 === n.options.centerMode && n.slideCount <= n.options.slidesToShow ? n.slideOffset = n.slideWidth * Math.floor(n.options.slidesToShow) / 2 - n.slideWidth * n.slideCount / 2 : !0 === n.options.centerMode && !0 === n.options.infinite ? n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2) - n.slideWidth : !0 === n.options.centerMode && (n.slideOffset = 0, n.slideOffset += n.slideWidth * Math.floor(n.options.slidesToShow / 2)), t = !1 === n.options.vertical ? e * n.slideWidth * -1 + n.slideOffset : e * o * -1 + r, !0 === n.options.variableWidth)
            if (s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(e) : n.$slideTrack.children(".slick-slide").eq(e + n.options.slidesToShow), t = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, !0 === n.options.centerMode) s = n.slideCount <= n.options.slidesToShow || !1 === n.options.infinite ? n.$slideTrack.children(".slick-slide").eq(e) : n.$slideTrack.children(".slick-slide").eq(e + n.options.slidesToShow + 1), t = !0 === n.options.rtl ? s[0] ? -1 * (n.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, t += (n.$list.width() - s.outerWidth()) / 2;
            else if (!0 === n.options.outerEdgeLimit) {
            var l, d;
            d = ((l = n.$slides.last())[0] ? -1 * l[0].offsetLeft : 0) - l.width() + this.$slider.width(), t = Math.min(Math.max(t, d - 3), 0), i(window).width() - (l.offset().left + l.outerWidth()) - (i(window).width() - (n.$slider.offset().left + n.$slider.outerWidth())) > -1 ? (n.$nextArrow.addClass("slick-disabled").attr("aria-disabled", "true").fadeOut("300", function() {
                i(this).hide()
            }), n.touchObject.edgeHit = !0, !0 === n.options.arrows && n.slideCount > n.options.slidesToShow && (n.$nextArrow && n.$nextArrow.off("click.slick", n.changeSlide), !0 === n.options.accessibility && n.$nextArrow && n.$nextArrow.off("keydown.slick", n.keyHandler))) : (n.$nextArrow.removeClass("slick-disabled").attr("aria-disabled", "false").fadeIn("300"), !0 === n.options.arrows && n.slideCount > n.options.slidesToShow && (n.$nextArrow.off("click.slick").on("click.slick", {
                message: "next"
            }, n.changeSlide), !0 === n.options.accessibility && n.$nextArrow.on("keydown.slick", n.keyHandler)))
        }
        return t
        ...
        e.$slides.add(e.$slideTrack.find(".slick-cloned")).attr({
            ...
            !0 === e.options.dots && i(this).attr("aria-describedby", "slick-slide" + e.instanceUid + o)
